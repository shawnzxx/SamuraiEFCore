    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "I told you watch out my shape sword, ohh well!" },
                    { 2, 1, "I am here to defeat you" },
                    { 3, 1, "I am happy now" },
                    { 4, 2, "Trash, Trash, Trash!!" },
                    { 5, 2, "Come, I will show you the way" },
                    { 6, 3, "Roger that" },
                    { 7, 3, "It's a fun game, isn't it?" },
                    { 8, 4, "Dame it! Dame it!! Dame it!!!" },
                    { 9, 5, "OMG" },
                    { 10, 5, "Let's get it to work now" },
                    { 11, 5, "Shiock! We finaly did that, Let's have a chicken soup tonight" }
                });
